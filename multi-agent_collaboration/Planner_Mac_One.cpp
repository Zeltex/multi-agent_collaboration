...
std::vector<std::set<Temp>> Planner_Mac_One::get_agent_handoff_infos(const Agent_Combination& agents,
...
std::vector<size_t> Planner_Mac_One::calculate_adjusted_agent_handoffs(std::vector<std::set<Temp>>& agents_handoffs) {
...
void Planner_Mac_One::initialize_solutions() {
